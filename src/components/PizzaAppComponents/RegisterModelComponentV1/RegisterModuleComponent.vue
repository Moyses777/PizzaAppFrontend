...
form.row.g-3.formregister
    ...
    .col-md-6
      ...
      ui5-input#inputEmail4.form-control(type='Text' :class="{'inputError': isLastname}" show-clear-icon :value="txtLastname" @input="txtLastname = $event.target.value" @keyup="validateLastname()")
      ...
      if (this.isChecked) {
        if (
          ...
          if (
            ...
            let response = await fetch("https://localhost:44376/register", {
              method: "POST",
              headers: {
