...
export default defineComponent({
  ...
  methods: {
    /**
     * This method validate all the inputs and if are correct all inputs by characters
     * after that will call the class notification and throw the API promise to connect
     * and finally clean all inputs.
     */
    ...
    /**
     * validate the input name to be longer than 4 characters or if is empty
     */
    ...
    /**
     * validate the input lastname to be longer than 4 characters or if is empty
     */
    ...
    /**
     * validate input telephone to not be longer or shorter than 10
     */
    validateTelephone: function () {
      this.isTelephone = this.txtTelephone.length != 10;
    },
    /**
     * validate input address to be longer than 8 characters
     */
    validateAddress: function () {
      this.isAddress = this.txtAddress.length < 8;
    },
    /**
     * validate input city to be longer than 4 characters
     */
    validateCity: function () {
      this.isCity = this.txtCity.length < 4;
    },
    /**
     * validate input Zip to be longer than 4 characters
     */
    validateZip: function () {
      this.isZip = this.txtZip.toString().length < 4;
    },
    /**
     * validate input state to be longer than 2 characters
     */
